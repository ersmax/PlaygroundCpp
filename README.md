...
- [Digital Time representation change](11_Separate_Compilation_Namespaces/01_Separate_compilation/11_5_Digital_Time_change/11_5_Digital_Time_Change.cpp) - Describes, in words, how to modify the original `DigitalTime` interface and implementation to use a single `minute` field internally and summarizes the concrete changes realized in `11_5_dTime.h` / `11_5_dTime.cpp`.
