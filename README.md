...
2. [SmartBut definition](14_Inheritance/01_Inheritance_basics/14_02_Smart_But/14_02_Smart.h) - Declares `SmartBut` as a derived class of `Smart` that adds a `bool crazy` data member, an `isCrazy()` accessor, and suitable constructors, illustrating how to extend a base class.
