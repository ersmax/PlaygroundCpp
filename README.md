...
4. [Output by reference (variant)](4_Parameters_and_Overloading/4.1_Parameters/4_4_Output_by_reference_2.cpp) - Variant demonstrating effect of removing `&` from a parameter.
