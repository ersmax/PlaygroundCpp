//   This program showcases the use of friend functions
// to get the advantage of automatic type conversion by means of constructor
// for all the function arguments, and the second advantage of member functions
// of direct access to private members (variables and functions).
